...
Audio playback is not implemented, and this is not Tauri editor parity. Windows/X11
implement the same numeric crop and output-size workflow; physical macOS, Windows and
