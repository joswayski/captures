...
- Review recordings on an aspect-correct filmstrip timeline, adjust crop and audio, then save a named copy by default or explicitly replace the original, with preserved quality, optional compression, or an exact maximum file size.
