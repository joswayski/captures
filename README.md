...
- Mini previews for quick copy, save, and drag into other apps. Minimize the stack into a corner folder when it covers the desktop; a new capture brings it back
