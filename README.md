...
a pending capture even with another app focused. The macOS workspace also connects
region draw/move/resize, aspect constraints, freeze, and auto-start to shared Rust
capture logic; matching Windows/Linux selector integration is in progress.
