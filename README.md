...
- Review recordings on an aspect-correct filmstrip timeline, adjust crop and audio, then update the original or save a named copy with preserved quality, optional compression, or an exact maximum file size.
