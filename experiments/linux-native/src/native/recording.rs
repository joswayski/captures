...
pub fn start_with_actions(
    ...
    window.set_title(Some("Captures recording controls"));
    ...
    }
    {
        ...
        restart.connect_clicked(move |_| {
            ...
            ui::confirm(
                ...
                "Restart",
                move || restart_session(&window, &elapsed, &pause, &stop, &discard, &session),
            );
        });
    }
    {
    ...
    }
    {
        ...
        hide.connect_clicked(move |button| {
            window.hide();
            let notice = gtk::Window::new();
            notice.set_title(Some("Captures recording"));
    ...
    }
    {
        ...
        discard.connect_clicked(move |_| {
            ...
            ui::confirm(
                ...
                "Delete",
                move || discard_session(&window, &session),
            );
        });
    }
    {
...
fn set_button_icon(button: &gtk::Button, icon_name: &str, accessible_name: &str) {
    ...
    ui::named(button, accessible_name);
}
...
fn open_editor_legacy(path: PathBuf, directory: PathBuf, on_saved: Rc<dyn Fn(PathBuf)>) {
    ...
    }
    {
        ...
        play.connect_clicked(move |_| {
            let result = gio::AppInfo::launch_default_for_uri(
