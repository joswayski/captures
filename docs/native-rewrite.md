...
countdown starts only after confirmation. Windows/X11 selector integration is
underway in the same feature slice; Wayland's host visibility/placement gate
remains open. Neither this stage nor its synthetic input/render checks close the
