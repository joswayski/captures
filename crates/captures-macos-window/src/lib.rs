...
use objc2_foundation::{
    NSNumber, NSObject, NSPoint, NSProcessInfo, NSRect, NSSize, NSString,
};
...
/// app as frontmost. Pure helper for unit tests.
...
mod tests {
    ...
    fn conceals_documents_only_when_another_app_is_frontmost() {
        ...
        assert!(!should_conceal_documents_for_capture_activation(false, false));
        assert!(!should_conceal_documents_for_capture_activation(false, true));
